# fieldlogbook.com — Executive Contact Sheet (Batch 4B, Gap-fill 2/3)
...
|---|---------|------|---------|
| 1 | ServiceTitan | Ara Mahdessian | email |
| 2 | Jobber | Sam Pillar | email; LinkedIn |
| 3 | ServiceMax | Neil Barua | email |
| 4 | FieldAware | (CEO) | email |
| 5 | mHelpDesk | (CEO) | LinkedIn URL |
| 6 | Workiz | Adi Ekshtain | email; LinkedIn |
| 7 | Jobber LatAm | (GM) | email; LinkedIn |
| 8 | ClickSoftware | (CEO) | email; LinkedIn |
...
|-------|--------|:---:|
| **Exec** | Ara Mahdessian — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/servicetitan | H |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of servicetitan.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 88 | — |
| **Intent signal** | FSM leader; field documentation | — |
| **Note** | — | — |
...
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of getjobber.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 85 | — |
| **Intent signal** | Home services software | — |
...
|-------|--------|:---:|
| **Exec** | Ian Heidt — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/housecallpro | H |
| **Public email(s)** | support@housecallpro.com | H |
| **Source** | live curl sweep of housecallpro.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 82 | — |
| **Intent signal** | Field service platform | — |
| **Note** | — | — |
...
|-------|--------|:---:|
| **Exec** | Neil Barua — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/ptc | H |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of servicemax.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 80 | — |
| **Intent signal** | Field service management | — |
| **Note** | — | — |

### FieldAware — fieldaware.com

| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | (CEO) — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/gps-insight-llc | H |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of fieldaware.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 78 | — |
| **Intent signal** | Field service software | — |
| **Note** | — | — |
...
| **Exec** | (CEO) — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email(s)** | support@mhelpdesk.com | H |
| **Source** | live curl sweep of mhelpdesk.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 75 | — |
| **Intent signal** | FSM for SMBs | — |
| **Note** | — | — |
...
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Adi Ekshtain — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of workiz.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 72 | — |
| **Intent signal** | Field service platform | — |
| **Note** | site did not respond to sweep (blocked/timeout/JS) — verify via LinkedIn search (L) | — |

### Jobber LatAm — jobber.com
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of jobber.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 68 | — |
| **Intent signal** | LatAm expansion | — |
| **Note** | site did not respond to sweep (blocked/timeout/JS) — verify via LinkedIn search (L) | — |
...
|-------|--------|:---:|
| **Exec** | Arka Dhar — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/zinier-inc | H |
| **Public email(s)** | hello@zinier.com | H |
| **Source** | live curl sweep of zinier.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 65 | — |
| **Intent signal** | Field service AI | — |
| **Note** | — | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of clicksoftware.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 62 | — |
| **Intent signal** | FSM enterprise | — |
...
## Files
- **Lead list:** `leads_*` in `fieldlogbook.com/01-research/`
