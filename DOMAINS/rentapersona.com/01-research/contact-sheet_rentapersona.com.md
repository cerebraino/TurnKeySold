# rentapersona.com — Executive Contact Sheet (Batch 5B, Gap-fill 2/3)
...
|---|---------|------|---------|
| 1 | Care.com | Brad Wilson | email |
| 2 | Cuideo | Roberto Valdés | email |
| 3 | Cronoshare | (CEO) | email |
| 4 | TaskRabbit (LatAm) | Ania Smith | email; LinkedIn |
| 5 | Superprof | Wilfried Granier | email; LinkedIn |
| 6 | Zaask | (CEO) | email; LinkedIn |
| 7 | Mil Anuncios | (GM) | email; LinkedIn |
| 8 | Pawshake | (CEO) | email; LinkedIn |
...
|-------|--------|:---:|
| **Exec** | Brad Wilson — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/care-com | H |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of care.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 85 | — |
| **Intent signal** | Care marketplace; companionship | — |
| **Note** | — | — |
...
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Roberto Valdés — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/cuideo | H |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of cuideo.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 82 | — |
| **Intent signal** | Spanish elder care platform | — |
| **Note** | — | — |

### Cronoshare — cronoshare.com

| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | (CEO) — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/cronoshare | H |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of cronoshare.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 80 | — |
| **Intent signal** | Spanish services marketplace | — |
| **Note** | — | — |

### TaskRabbit (LatAm) — taskrabbit.com
...
| **Source** | live curl sweep of taskrabbit.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 78 | — |
| **Intent signal** | Task marketplace | — |
| **Note** | site did not respond to sweep within session window — exec email/LinkedIn must be resolved via LinkedIn search (L) | — |

### Superprof — superprof.es

| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Wilfried Granier — CEO | — |
| **Company LinkedIn** | MISSING — site not yet swept (verify via owner LLM) | — |
| **Public email** | **MISSING** — site not yet swept (verify via owner LLM) | — |
| **Source** | live curl sweep of superprof.es (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 75 | — |
| **Intent signal** | Tutoring marketplace | — |
| **Note** | site did not respond to sweep within session window — exec email/LinkedIn must be resolved via LinkedIn search (L) | — |
...
| **Company LinkedIn** | MISSING — site not yet swept (verify via owner LLM) | — |
| **Public email** | **MISSING** — site not yet swept (verify via owner LLM) | — |
| **Source** | live curl sweep of zaask.pt (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 72 | — |
| **Intent signal** | Portuguese services marketplace | — |
| **Note** | site did not respond to sweep within session window — exec email/LinkedIn must be resolved via LinkedIn search (L) | — |

### Mil Anuncios — milanuncios.com
...
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of milanuncios.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 70 | — |
| **Intent signal** | Spanish classifieds; services | — |
| **Note** | no public contact found on sweep | — |

### Pawshake — pawshake.com
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of pawshake.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 68 | — |
| **Intent signal** | Pet sitting marketplace | — |
| **Note** | no public contact found on sweep | — |
...
## Files
- **Lead list:** `leads_*` in `rentapersona.com/01-research/`
...
|---|---|---|---|---|---|---|
| Care.com | Brad Wilson | CEO | `/in/bradleywilson` | `MISSING` | — | — |
| Cuideo | Roberto Valdés Gandarillas | CEO & Co-Founder | `/in/roberto-valdes-gandarillas-6890382` | `MISSING` | — | — |
| TaskRabbit (LatAm) | Ania Smith | CEO | `/in/aniasmith` | `MISSING` | — | — |
| Superprof | Wilfried Granier | CEO & Co-Founder | `/in/wilfried-granier-745b91133` | `MISSING` | — | — |
