...
|---|---|---|---|---|---|---|
| AB InBev | Michel Doukeris | CEO | `/in/michel-doukeris` | `MISSING` | — | — |
| Constellation Brands | Bill Newlands | CEO (retiring Apr 2026) | `/in/billnewlands` | `MISSING` | — | TURNOVER: retiring Apr 2026 |
| Heineken | Dolf van den Brink | CEO (stepping down May 2026) | `/in/dolfvandenbrink` | `MISSING` | — | TURNOVER: stepping down May 2026 |
| Molson Coors | Gavin Hattersley | Former CEO | `/in/gavin-hattersley` | `MISSING` | — | TURNOVER: retired Oct 2025 |
