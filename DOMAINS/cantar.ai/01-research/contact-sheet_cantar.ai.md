# cantar.ai — Executive Contact Sheet (Batch 1, Gap-fill 2/3)
...
|---|---------|------|---------|
| 1 | Smule | Jeff Smith | LinkedIn URL; email |
| 2 | Spotify (Latin Music) | Daniel Ek | LinkedIn URL; email |
| 3 | Smily (Starmaker) | — (CEO) | LinkedIn URL; email |
| 4 | Yousician | — (CEO) | LinkedIn URL; email |
| 5 | YouTube Music (Latin) | Neal Mohan | LinkedIn URL; email |
| 6 | Apple Music (Latin) | Oliver Schusser | LinkedIn URL; email |
...
| **Source** | live curl sweep of smule.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 92 | — |
| **Intent signal** | Karaoke/social singing; 100M+ users; Latin vertical | — |
| **Note** | No public contact found | — |

### Spotify (Latin Music) — spotify.com
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Daniel Ek — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of spotify.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 88 | — |
| **Intent signal** | Latin #1 streaming category; karaoke feature | — |
| **Note** | No public exec email | — |

### Smily (Starmaker) — starmaker.com
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | — (CEO) — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of starmaker.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 85 | — |
| **Intent signal** | Social singing app; Latin audience | — |
| **Note** | No public contact found | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of yousician.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 72 | — |
| **Intent signal** | Music learning; vocals | — |
| **Note** | No public contact found | — |

### YouTube Music (Latin) — youtube.com
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Neal Mohan — CEO (YouTube) | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of youtube.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 70 | — |
| **Intent signal** | Latin top category; karaoke | — |
| **Note** | No public exec email | — |

### Apple Music (Latin) — apple.com
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Oliver Schusser — SVP Apple Music | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of apple.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 68 | — |
| **Intent signal** | Apple Music Sing; Latin expansion | — |
...
## Files
- **Lead list:** `leads_*` in `cantar.ai/01-research/`
