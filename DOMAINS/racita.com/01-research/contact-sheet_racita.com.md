# racita.com — Executive Contact Sheet (Batch 5B, Gap-fill 2/3)
...
|---|---------|------|---------|
| 1 | Rita's Italian Ice | (CEO) | email; LinkedIn |
| 2 | SquadHelp | (CEO) | email; LinkedIn |
| 3 | BrandBucket | (CEO) | email; LinkedIn |
| 4 | Namecheap | Richard Kirkendall | email; LinkedIn |
| 5 | GoDaddy | Aman Bhutani | email; LinkedIn |
...
| **Source** | live curl sweep of ritasice.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 58 | — |
| **Intent signal** | 'Racita' phonetic brand | — |
| **Note** | site did not respond to sweep within session window — exec email/LinkedIn must be resolved via LinkedIn search (L) | — |

### SquadHelp — squadhelp.com
...
| **Source** | live curl sweep of squadhelp.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 55 | — |
| **Intent signal** | Brandable marketplace | — |
| **Note** | no public contact found on sweep | — |

### BrandBucket — brandbucket.com
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of brandbucket.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 52 | — |
| **Intent signal** | Brandable marketplace | — |
| **Note** | no public contact found on sweep | — |
...
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Richard Kirkendall — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of namecheap.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 50 | — |
| **Intent signal** | Registrar; premium marketplace | — |
| **Note** | no public contact found on sweep | — |
...
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Aman Bhutani — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of godaddy.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 48 | — |
| **Intent signal** | Registrar; aftermarket | — |
| **Note** | no public contact found on sweep | — |
...
## Files
- **Lead list:** `leads_*` in `racita.com/01-research/`
