# paycar.ai — Executive Contact Sheet (Batch 1, Gap-fill 2/3)
...
| 5 | Rocket Auto | Dan Gilbert | LinkedIn URL; email |
| 6 | Upstart | Dave Girouard | LinkedIn URL; email |
...
| **DMPS** | 93 | — |
| **Intent signal** | Largest used-car retailer; CarMax Auto Finance | — |
...
| **DMPS** | 91 | — |
| **Intent signal** | Fully digital car buying; payments core | — |
...
| **DMPS** | 88 | — |
| **Intent signal** | Vertical product brand for automotive payments | — |
...
| **DMPS** | 85 | — |
| **Intent signal** | Leading auto lender/digital bank | — |
...
| **DMPS** | 83 | — |
| **Intent signal** | Major auto finance; long generic domain | — |
| **Note** | No public contact found | — |

### Rocket Auto — rocketcompanies.com
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Dan Gilbert — Founder | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of rocketcompanies.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 75 | — |
| **Intent signal** | Auto financing via Rocket | — |
| **Note** | No public contact found | — |

### Upstart — upstart.com
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Dave Girouard — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of upstart.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 70 | — |
| **Intent signal** | AI lending into auto | — |
| **Note** | No public contact found | — |
...
## Files
- **Lead list:** `leads_*` in `paycar.ai/01-research/`
