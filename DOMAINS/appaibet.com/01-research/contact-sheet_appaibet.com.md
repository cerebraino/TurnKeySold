# appaibet.com — Executive Contact Sheet (Batch 4B, Gap-fill 2/3)
...
| 6 | Stake.com | (CEO) | email; LinkedIn |
| 7 | Betano | (CEO) | email; LinkedIn |
| 8 | RushBet | (CEO) | email; LinkedIn |
...
| **DMPS** | 82 | — |
| **Intent signal** | Gambling app; AI brand | — |
| **Note** | — | — |
...
| **Source** | live curl sweep of fanduel.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 80 | — |
| **Intent signal** | Gambling app; AI features | — |
| **Note** | — | — |
...
| **Source** | live curl sweep of betmgm.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 78 | — |
| **Intent signal** | Gambling app | — |
...
| **Source** | live curl sweep of flutter.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 72 | — |
| **Intent signal** | Gambling group | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of pointsbet.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 70 | — |
| **Intent signal** | Sports betting app | — |
| **Note** | no public contact found on sweep | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of entain.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 68 | — |
| **Intent signal** | BetMGM parent | — |
| **Note** | no public contact found on sweep | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of betano.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 62 | — |
| **Intent signal** | Kaizen; LATAM | — |
| **Note** | no public contact found on sweep | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of rushbet.co (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 60 | — |
| **Intent signal** | LATAM betting app | — |
| **Note** | no public contact found on sweep | — |
...
## Files
- **Lead list:** `leads_*` in `appaibet.com/01-research/`
