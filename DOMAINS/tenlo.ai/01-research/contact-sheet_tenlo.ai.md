# tenlo.ai — Executive Contact Sheet (Batch 2, Gap-fill 2/3)
...
|---|---------|------|---------|
| 1 | Mercado Libre | Marcos Galperin | email; LinkedIn |
| 2 | Rappi | Simón Borrero | email; LinkedIn |
| 3 | Linio | (CEO — verify) | email; LinkedIn |
| 4 | Falabella | (CEO — verify) | email; LinkedIn |
| 5 | Dafiti | (CEO — verify) | email; LinkedIn |
| 6 | Shopee (LatAm) | (CEO — verify) | email; LinkedIn |
| 7 | Liverpool (MX) | (CEO — verify) | email; LinkedIn |
| 8 | Coppel | (CEO — verify) | email; LinkedIn |
| 9 | Elektra | (CEO — verify) | email; LinkedIn |
| 10 | Cencosud | (CEO — verify) | email |
...
| **Source** | live curl sweep of mercadolibre.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 88 | — |
| **Intent signal** | LatAm's dominant marketplace; 'Tenlo' = commerce verb | — |
...
| Field | Detail | Confidence |
|-------|--------|:---:|
| **Exec** | Simón Borrero — CEO | — |
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of rappi.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 85 | — |
| **Intent signal** | Delivery; 'Tenlo' = the verb for delivery ('have it now') | — |
| **Note** | no public contact found on sweep | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of linio.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 82 | — |
| **Intent signal** | LatAm e-commerce | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of falabella.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 80 | — |
| **Intent signal** | LatAm retail group; e-commerce | — |
| **Note** | no public contact found on sweep | — |
...
| **Source** | live curl sweep of dafiti.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 78 | — |
| **Intent signal** | Fashion e-commerce | — |
| **Note** | site did not respond to sweep within session window — exec email/LinkedIn must be resolved via LinkedIn search (L) | — |

### Shopee (LatAm) — shopee.com
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of shopee.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 75 | — |
| **Intent signal** | E-commerce; LatAm expansion | — |
| **Note** | no public contact found on sweep | — |

### Liverpool (MX) — liverpool.com.mx
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of liverpool.com.mx (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 72 | — |
| **Intent signal** | Mexican retail; e-commerce | — |
| **Note** | no public contact found on sweep | — |
...
| **Company LinkedIn** | MISSING — site not yet swept (verify via owner LLM) | — |
| **Public email** | **MISSING** — site not yet swept (verify via owner LLM) | — |
| **Source** | live curl sweep of coppel.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 70 | — |
| **Intent signal** | Mexican retail; digital push | — |
| **Note** | site did not respond to sweep within session window — exec email/LinkedIn must be resolved via LinkedIn search (L) | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of elektra.com.mx (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 68 | — |
| **Intent signal** | Mexican retail; fintech | — |
| **Note** | no public contact found on sweep | — |
...
|-------|--------|:---:|
| **Exec** | (CEO — verify) — CEO | — |
| **Company LinkedIn** | https://www.linkedin.com/company/cencosud-s-a- | H |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of cencosud.com (+/about /contact /team) 2026-08-14; leads file for exec/DMPS | — |
| **DMPS** | 65 | — |
| **Intent signal** | Chilean retail group | — |
| **Note** | — | — |
...
## Files
- **Lead list:** `leads_*` in `tenlo.ai/01-research/`
