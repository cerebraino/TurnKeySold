# lahispano.net — Executive Contact Sheet (Batch 5B, Gap-fill 2/3)
...
|---|---------|------|---------|
| 1 | Univision Los Angeles | (GM — verify) | email; LinkedIn |
| 2 | Telemundo 52 | (GM — verify) | email; LinkedIn |
| 3 | La Opinión | Monica Lozano | LinkedIn URL |
| 4 | Mitú | (CEO) | LinkedIn URL |
| 5 | Remezcla | (CEO) | email; LinkedIn |
| 6 | Latino Media Network | (CEO) | email; LinkedIn |
| 7 | Alianza Americas | (Director) | LinkedIn URL |
...
### Univision Los Angeles — univision.com
...
| **Source** | live curl sweep of univision.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 88 | — |
| **Intent signal** | LA Spanish media; network extension | — |
| **Note** | no public contact found on sweep | — |

### Telemundo 52 — telemundo.com
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of telemundo.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 85 | — |
| **Intent signal** | LA Spanish station | — |
| **Note** | no public contact found on sweep | — |
...
| **Source** | live curl sweep of laopinion.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 80 | — |
| **Intent signal** | LA Spanish newspaper | — |
...
| **Source** | live curl sweep of wearemitu.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 75 | — |
| **Intent signal** | Latino digital media | — |
| **Note** | — | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of remezcla.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 72 | — |
...
| **Company LinkedIn** | MISSING — not found on site sweep | — |
| **Public email** | **MISSING** — no public address found on site sweep | — |
| **Source** | live curl sweep of latinomedianetwork.com (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 68 | — |
| **Intent signal** | Hispanic audio media | — |
| **Note** | no public contact found on sweep | — |
...
| **Source** | live curl sweep of alianzaamericas.org (+/about /contact /team) 2026-08-15; leads file for exec/DMPS | — |
| **DMPS** | 65 | — |
...
## Files
- **Lead list:** `leads_*` in `lahispano.net/01-research/`
